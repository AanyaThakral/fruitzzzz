...
function setup(){
  createCanvas(displayWidth=1276,displayHeight=602 );
    ball=createSprite(displayWidth=300,displayHeight=250,10,10);
    
    ball.shapeColor="red";
    ball.scale=0.2;
    
    score=0;
    gameOver=createSprite(displayWidth=638,displayHeight=200,30,20);
    restart=createSprite(displayWidth=638,displayHeight=400,30,20);
